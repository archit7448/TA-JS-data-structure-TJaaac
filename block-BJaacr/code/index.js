...
for(let i = 0 ; i < got.houses[1].people.length ; i = i+1){
  console.log(`description: ${got.houses[1].people[i].description}`)
}
...
for(let i = 0 ; i < allDescription.length ; i = i+1){
