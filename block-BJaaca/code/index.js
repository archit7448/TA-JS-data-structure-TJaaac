...
character.greet = function (){ return alert(`I am ${character.characterName} ${character["sur name"]} and my title is ${character.title}`)}
...
character.greet = function () {
    return alert(`She is ${character.characterName} ${character["sur name"]} and her title is ${character.title}`)
}
...
function getAdult(){
    if(character.characterAge > 18){
        return true
    }else{
        return false
    }
}
character.isAdult = getAdult()
